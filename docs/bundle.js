...
/* harmony import */ var _model_event_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/event.js */ "./src/model/event.js");
...
class Api {
  ...
  getEvents() {
    return this._load({url: `points`})
      .then(Api.toJSON)
      .then((events) => events.map(_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }
  ...
  updateEvent(event) {
    return this._load({
      url: `points/${event.id}`,
      method: Method.PUT,
      body: JSON.stringify(_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(event)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(Api.toJSON)
      .then(_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient);
  }
...
/* harmony import */ var _model_event_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../model/event.js */ "./src/model/event.js");
  ...
  getEvents() {
    if (Provider.isOnline()) {
      return this._api.getEvents()
        .then((events) => {
          const items = createStoreStructure(events.map(_model_event_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer));
    ...
    return Promise.resolve(storeEvents.map(_model_event_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToClient));
  }
  ...
  updateEvent(event) {
    if (Provider.isOnline()) {
      return this._api.updateEvent(event)
        .then((updatedEvent) => {
          this._store.setItem(updatedEvent.id, _model_event_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(updatedEvent));
          return updatedEvent;
        });
    }

    this._store.setItem(event.id, _model_event_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(Object.assign({}, event)));
  ...
  addEvent(event) {
    if (Provider.isOnline()) {
      return this._api.addEvent(event)
        .then((newEvent) => {
          this._store.setItem(newEvent.id, _model_event_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(newEvent));
          return newEvent;
        });
    }

    const localNewEventId = Object(nanoid__WEBPACK_IMPORTED_MODULE_0__["nanoid"])();
    const localNewEvent = Object.assign({}, event, {id: localNewEventId});

    this._store.setItem(localNewEvent.id, _model_event_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(localNewEvent));
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EVENT_TYPES, SortType, UserAction, UpdateType, FilterType, MenuItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _presenter_header_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./presenter/header.js */ "./src/presenter/header.js");
/* harmony import */ var _presenter_table_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./presenter/table.js */ "./src/presenter/table.js");
/* harmony import */ var _model_event_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/event.js */ "./src/model/event.js");
...
/* harmony import */ var _view_add_new_event_button_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view/add-new-event-button.js */ "./src/view/add-new-event-button.js");
...
const AUTHORIZATION = `Basic sr68h4684aef412`;
...
const destinationsStore = new _api_store_js__WEBPACK_IMPORTED_MODULE_10__["default"](STORE_NAME_DESTINATIONS, window.localStorage);
const offersStore = new _api_store_js__WEBPACK_IMPORTED_MODULE_10__["default"](STORE_NAME_OFFERS, window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_11__["default"](api, store, destinationsStore, offersStore);

const eventsModel = new _model_event_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
const filterModel = new _model_filter_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
let statisticsComponent = null;

const handleSiteMenuClick = (menuItem) => {
  switch (menuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_7__["MenuItem"].ADD_NEW_EVENT:
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(statisticsComponent);
    ...
    case _const_js__WEBPACK_IMPORTED_MODULE_7__["MenuItem"].TABLE:
      ...
      break;
    case _const_js__WEBPACK_IMPORTED_MODULE_7__["MenuItem"].STATISTICS:
      tablePresenter.destroy();
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(statisticsComponent);
      statisticsComponent = new _view_statistics_js__WEBPACK_IMPORTED_MODULE_6__["default"](eventsModel.getEvents());
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(siteMainElement, statisticsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
      siteMenuComponent.setMenuItem(_const_js__WEBPACK_IMPORTED_MODULE_7__["MenuItem"].STATISTICS);
      addNewEventButtonComponent.getElement().disabled = false;
      break;
  }
};

const headerPresenter = new _presenter_header_js__WEBPACK_IMPORTED_MODULE_0__["default"](siteHeaderElement, eventsModel, filterModel);
headerPresenter.init();
const tripControlsElement = siteHeaderElement.querySelector(`.trip-main__trip-controls`);

const siteMenuComponent = new _view_site_menu_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(tripControlsElement, siteMenuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].AFTERBEGIN);
siteMenuComponent.setMenuClickHandler(handleSiteMenuClick);
const addNewEventButtonComponent = new _view_add_new_event_button_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(siteHeaderElement, addNewEventButtonComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
...
const tablePresenter = new _presenter_table_js__WEBPACK_IMPORTED_MODULE_1__["default"](tableElement, eventsModel, filterModel, apiWithProvider, addNewEventButtonComponent.getElement());
tablePresenter.init();

apiWithProvider.getDestinations()
  .then((destinations) => {
    eventsModel.setDestinations(_const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].INIT_DESTINATIONS, destinations);
  })
  .catch(() => {
    eventsModel.setDestinations(_const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].INIT_DESTINATIONS, []);
  });

apiWithProvider.getOffers()
  .then((offers) => {
    eventsModel.setOffers(_const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].INIT_OFFERS, offers);
  })
  .catch(() => {
    eventsModel.setOffers(_const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].INIT_OFFERS, []);
  });

apiWithProvider.getEvents()
  .then((events) => {
    eventsModel.setEvents(_const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].INIT, events);
  })
  .catch(() => {
    eventsModel.setEvents(_const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].INIT, []);
  });
...
class Event extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._events = [];
    this._destinations = [];
...
/* harmony import */ var _view_event_edit_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/event-edit.js */ "./src/view/event-edit.js");
...
class Event {
  ...
  init(event) {
    ...
    this._eventComponent = new _view_event_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._event);
    this._eventEditComponent = new _view_event_edit_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._event, this._destinationsList, this._offersList);
    ...
    if (prevEventComponent === null || prevEventEditComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._eventListContainer, this._eventComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
      return;
    }

    if (this._mode === Mode.DEFAULT) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventComponent, prevEventComponent);
    }

    if (this._mode === Mode.EDITING) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventComponent, prevEventEditComponent);
      this._mode = Mode.DEFAULT;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevEventComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevEventEditComponent);
  }

  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._eventComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._eventEditComponent);
  }
  ...
  _replaceEventToForm() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventEditComponent, this._eventComponent);
  ...
  _replaceFormToEvent() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventComponent, this._eventEditComponent);
  ...
  _handleFavoriteClick() {
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].UPDATE_WITHOUT_RELOAD,
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].PATCH_WITHOUT_RELOAD,
        Object.assign(
            this._event,
            {
  ...
  _handleFormSubmit(updatedEvent) {
    ...
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].UPDATE_EVENT,
        isMinorUpdate ? _const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MINOR : _const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].PATCH,
        updatedEvent
    );
  }
  ...
  _handleDeleteClick(deletedEvent) {
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].DELETE_EVENT,
...
/* harmony import */ var _view_trip_controls_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/trip-controls.js */ "./src/view/trip-controls.js");
/* harmony import */ var _view_site_menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/site-menu.js */ "./src/view/site-menu.js");
...
class Header {
  constructor(headerContainer, eventsModel, filterModel) {
    ...
    this._tripControlsComponent = new _view_trip_controls_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._siteMenuComponent = new _view_site_menu_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
  ...
  _handleFilterTypeChange(filterType) {
    ...
    this._filterModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_5__["UpdateType"].MAJOR, filterType);
  }
  ...
  _renderTripInfo() {
    ...
    this._tripInfoComponent = new _view_trip_info_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._getEvents());
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._headerContainer, this._tripInfoComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].AFTERBEGIN);
  }

  _clearTripInfo() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._tripInfoComponent);
  }

  _renderSiteMenu() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._tripControlsComponent, this._siteMenuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
  }

  _renderFilter() {
    if (this._filterComponent !== null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._filterComponent);
    }
    this._filterComponent = new _view_filter_js__WEBPACK_IMPORTED_MODULE_3__["default"](this._filterModel.getFilter(), this._eventsModel);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._tripControlsComponent, this._filterComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
  ...
  _renderTripControls() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._headerContainer, this._tripControlsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].AFTERBEGIN);
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NewEvent; });
...
const NEW_EVENT_BLANK = {
  ...
  startDate: Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_2__["getCurrentDate"])(),
  endDate: Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_2__["getCurrentDate"])(),
  price: ``,
  offers: [],
  isFavorite: false,
  isNewEvent: true
...
class NewEvent {
  ...
  init() {
    ...
    this._eventEditComponent = new _view_event_edit_js__WEBPACK_IMPORTED_MODULE_0__["default"](NEW_EVENT_BLANK, this._destinationsList, this._offersList);
    this._eventEditComponent.setFormSubmitHandler(this._handleFormSubmit);
    this._eventEditComponent.setDeleteClickHandler(this._handleDeleteClick);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._tableContainer, this._eventEditComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTERBEGIN);
  ...
  destroy() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._eventEditComponent);
    this._eventEditComponent = null;
  ...
  _handleFormSubmit(updatedEvent) {
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].ADD_EVENT,
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MINOR,
        updatedEvent
    );
  }
...
/* harmony import */ var _view_loading_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/loading.js */ "./src/view/loading.js");
...
/* harmony import */ var _view_event_day_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/event-day.js */ "./src/view/event-day.js");
/* harmony import */ var _view_event_day_list_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/event-day-list.js */ "./src/view/event-day-list.js");
/* harmony import */ var _view_no_events_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/no-events.js */ "./src/view/no-events.js");
/* harmony import */ var _event_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./event.js */ "./src/presenter/event.js");
/* harmony import */ var _new_event_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./new-event.js */ "./src/presenter/new-event.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _utils_event_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/event.js */ "./src/utils/event.js");
...
class Table {
  constructor(tableContainer, eventsModel, filterModel, api, addNewEventButton) {
    ...
    this._eventListComponent = new _view_event_list_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._noEventsComponent = new _view_no_events_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._loadingComponent = new _view_loading_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  destroy() {
    this._clearTable();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._eventListComponent);
  ...
  createEvent() {
    ...
    this._newEventPresenter = new _new_event_js__WEBPACK_IMPORTED_MODULE_7__["default"](this._tableContainer, this._handleViewAction, this._eventsModel.getDestinations(), this._eventsModel.getOffers(), this._addNewEventButton);
  ...
  _getEvents() {
    ...
    const filtredEvents = _utils_filter_js__WEBPACK_IMPORTED_MODULE_11__["filter"][filterType](events);

    switch (this._currentSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["SortType"].TIME:
        return new Map().set(``, (filtredEvents.sort(_utils_event_js__WEBPACK_IMPORTED_MODULE_9__["sortEventsByTime"])));
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["SortType"].PRICE:
        return new Map().set(``, (filtredEvents.sort(_utils_event_js__WEBPACK_IMPORTED_MODULE_9__["sortEventsByPrice"])));
    }

    return Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_9__["sortEventsByDays"])(filtredEvents);
  }
  ...
  _handleViewAction(actionType, updateType, updatedItem) {
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["UserAction"].UPDATE_EVENT:
        this._eventPresenter[updatedItem.id].setViewState(_event_js__WEBPACK_IMPORTED_MODULE_6__["State"].SAVING);
        this._api.updateEvent(updatedItem).then((response) => {
          this._eventsModel.updateEvent(updateType, response);
        })
        .catch(() => {
          this._eventPresenter[updatedItem.id].setViewState(_event_js__WEBPACK_IMPORTED_MODULE_6__["State"].ABORTING);
        });
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["UserAction"].UPDATE_WITHOUT_RELOAD:
        this._api.updateEvent(updatedItem).then((response) => {
          this._eventsModel.updateEvent(updateType, response);
        })
        .catch(() => {
        ...
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["UserAction"].ADD_EVENT:
        ...
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["UserAction"].DELETE_EVENT:
        this._eventPresenter[updatedItem.id].setViewState(_event_js__WEBPACK_IMPORTED_MODULE_6__["State"].DELETING);
  ...
  _tableHandleModelChange(updateType, data) {
    switch (updateType) {
      ...
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["UpdateType"].MAJOR:
        ...
        this._addNewEventButton.disabled = false;
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["UpdateType"].INIT_DESTINATIONS:
        this._isDestinationLoaded = true;
        if (this._isEventsLoaded && this._isOffersLoaded) {
          this._loadTable();
        }
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["UpdateType"].INIT_OFFERS:
  ...
  _renderSort() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._tableContainer, this._sortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].AFTERBEGIN);
  }

  _renderEvent(eventList, event) {
    const eventPresenter = new _event_js__WEBPACK_IMPORTED_MODULE_6__["default"](eventList, this._handleViewAction, this._handleModeChange, this._eventsModel.getDestinations(), this._eventsModel.getOffers());
    eventPresenter.init(event);
    this._eventPresenter[event.id] = eventPresenter;
  }

  _renderLoading() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._tableContainer, this._loadingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].AFTERBEGIN);
  }

  _renderNoEvents() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._tableContainer, this._noEventsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].AFTERBEGIN);
  }

  _renderEventList(events) {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._tableContainer, this._eventListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);

    let mapIndex = 0;
    events.forEach((value, key) => {
      mapIndex++;
      const eventDayComponent = new _view_event_day_js__WEBPACK_IMPORTED_MODULE_3__["default"](key, mapIndex);
      this._eventDayComponents.push(eventDayComponent);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._eventListComponent, eventDayComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);

      const eventDayListComponent = new _view_event_day_list_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
      this._eventDayListComponents.push(eventDayListComponent);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(eventDayComponent, eventDayListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
  ...
  _clearEventList() {
    ...
    this._eventPresenter = {};
    this._eventDayComponents.forEach((component) => Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(component));
    this._eventDayComponents = [];
    this._eventDayListComponents.forEach((component) => Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(component));
    this._eventDayListComponents = [];
  }
  ...
  _clearTable(resetSortType = false) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._noEventsComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._loadingComponent);
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInteger, getRandomElement, updateItem, capitalizeFirst */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!****************************!*\
  !*** ./src/utils/event.js ***!
  \****************************/
/*! exports provided: getEventsInOrder, getPreposition, getCurrentDate, formatFullDate, formatTime, formatDuration, getShortDate, sortEventsByTime, sortEventsByPrice, sortEventsByDays */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEventsInOrder", function() { return getEventsInOrder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPreposition", function() { return getPreposition; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortEventsByTime", function() { return sortEventsByTime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortEventsByPrice", function() { return sortEventsByPrice; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortEventsByDays", function() { return sortEventsByDays; });
...
const getPreposition = (type) => {
  return _const_js__WEBPACK_IMPORTED_MODULE_0__["EVENT_TYPES"].activity.includes(type) ? `in` : `to`;
};
...
const formatFullDate = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`MM/DD/YY HH:mm`);
};
...
const formatDuration = (startDate, endDate) => {
  ...
  const days = moment__WEBPACK_IMPORTED_MODULE_1___default.a.duration(duration).days();
  const hours = moment__WEBPACK_IMPORTED_MODULE_1___default.a.duration(duration).hours();
  const minutes = moment__WEBPACK_IMPORTED_MODULE_1___default.a.duration(duration).minutes();
...
/* harmony import */ var _event_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./event.js */ "./src/utils/event.js");



const filter = {
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].EVERYTHING]: (events) => events.slice(),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FUTURE]: (events) => events.filter((event) => event.startDate > Object(_event_js__WEBPACK_IMPORTED_MODULE_1__["getCurrentDate"])()),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].PAST]: (events) => events.filter((event) => event.endDate < Object(_event_js__WEBPACK_IMPORTED_MODULE_1__["getCurrentDate"])())
};
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: countMoneyByTypes, countTransportTrip, countTimeSpend */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "countMoneyByTypes", function() { return countMoneyByTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "countTransportTrip", function() { return countTransportTrip; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "countTimeSpend", function() { return countTimeSpend; });
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
const countMoneyByTypes = (events) => {
  const allEventTypes = _const_js__WEBPACK_IMPORTED_MODULE_0__["EVENT_TYPES"].transfer.concat(_const_js__WEBPACK_IMPORTED_MODULE_0__["EVENT_TYPES"].activity);
...
const countTransportTrip = (events) => {
  const transportWithTripCount = _const_js__WEBPACK_IMPORTED_MODULE_0__["EVENT_TYPES"].transfer.map((type) => {
    const transports = [];
...
const countTimeSpend = (events) => {
  const getDurationInHours = (startDate, endDate) => {
    const duration = endDate - startDate;
    const days = moment__WEBPACK_IMPORTED_MODULE_2___default.a.duration(duration).days();
    let hours = moment__WEBPACK_IMPORTED_MODULE_2___default.a.duration(duration).hours();
    if (!days === 0) {
      hours = days * 24 + hours;
    }
    return hours;
  ...
  timeSpendStatistics.points = events.map((event) => {
    return `${icons.get(event.type)} ${Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_1__["getPreposition"])(event.type).toUpperCase()} ${event.destination.toUpperCase()}`;
  });
...
/***/ "./src/view/add-new-event-button.js":
/*!******************************************!*\
  !*** ./src/view/add-new-event-button.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AddNewEventButton; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const.js */ "./src/const.js");



class AddNewEventButton extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  ...
  _getTemplate() {
    return `<button class="trip-main__event-add-btn  btn  btn--big  btn--yellow" type="button" id="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].ADD_NEW_EVENT}">New event</button>`;
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventDayList; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");


class EventDayList extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  _getTemplate() {
    return (
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventDay; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _utils_event_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/event.js */ "./src/utils/event.js");



class EventDay extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _getTemplate() {
    ...
    const dateShort = Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_1__["getShortDate"])(date);
...
const BLANK_EVENT = {
  type: `taxi`,
  destination: ``,
  startDate: Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_0__["getCurrentDate"])(),
  endDate: Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_0__["getCurrentDate"])(),
  price: ``,
  offers: [],
  isFavorite: false,
};

class EventEdit extends _smart_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  ...
  _createTypeTemplate(type, isDisabled) {
    ...
    <div class="event__type-list">
      ${Object.keys(_const_js__WEBPACK_IMPORTED_MODULE_2__["EVENT_TYPES"]).map((key) => `<fieldset class="event__type-group">
      <legend class="visually-hidden">${key}</legend>

      ${_const_js__WEBPACK_IMPORTED_MODULE_2__["EVENT_TYPES"][key].map((eventType) => `<div class="event__type-item">
      ...
      <header class="event__header">
        ...
        <div class="event__field-group  event__field-group--destination">
          <label class="event__label  event__type-output" for="event-destination-1">
            ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["capitalizeFirst"])(type)} ${Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_0__["getPreposition"])(type)}
          </label>
        ...
        <div class="event__field-group  event__field-group--time">
          ...
          <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_0__["formatFullDate"])(startDate)}"${isDisabled ? ` disabled` : ``}>
          &mdash;
          <label class="visually-hidden" for="event-end-time-1">
            To
          </label>
          <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_0__["formatFullDate"])(endDate)}"${isDisabled ? ` disabled` : ``}>
        </div>
  ...
  _setDatepicker() {
    ...
    this._endDatepicker = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(
...
class EventList extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  _getTemplate() {
    return (
  ...
  _getTemplate() {
    ...
    return (
      ...
      <div class="event">
        ...
        <h3 class="event__title">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["capitalizeFirst"])(type)} ${Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_1__["getPreposition"])(type)} ${destination}</h3>

        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time" datetime="${startDate.toISOString()}">${Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(startDate)}</time>
            &mdash;
            <time class="event__end-time" datetime="${endDate.toISOString()}">${Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(endDate)}</time>
          </p>
          <p class="event__duration">${Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_1__["formatDuration"])(startDate, endDate)}</p>
        </div>
...
class Filter extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _createFilterItemTemplate(currentFilter, checkedFilter) {
    const isDisabled = !_utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["filter"][currentFilter](this._events).length > 0;
    ...
    <label class="trip-filters__filter-label" for="filter-${currentFilter}">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["capitalizeFirst"])(currentFilter)}</label>
  </div>`;
  }
...
class SiteMenu extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _getTemplate() {
    ...
    <nav class="trip-controls__trip-tabs  trip-tabs">
      <a class="trip-tabs__btn  trip-tabs__btn--active" id="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TABLE}" href="#">Table</a>
      <a class="trip-tabs__btn" id="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATISTICS}" href="#">Stats</a>
    </nav>
  </div>`;
  }
...
class Sort extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _getTemplate() {
    return (
      ...
      <div class="trip-sort__item  trip-sort__item--event">
        <input id="sort-event" class="trip-sort__input  visually-hidden" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}" type="radio" name="trip-sort" value="sort-event"${this._currentSortType === _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT ? ` checked` : ``}>
        <label class="trip-sort__btn" for="sort-event">Event</label>
      </div>

      <div class="trip-sort__item  trip-sort__item--time">
        <input id="sort-time" class="trip-sort__input  visually-hidden" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME}" type="radio" name="trip-sort" value="sort-time"${this._currentSortType === _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME ? ` checked` : ``}>
      ...
      <div class="trip-sort__item  trip-sort__item--price">
        <input id="sort-price" class="trip-sort__input  visually-hidden" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE}" type="radio" name="trip-sort" value="sort-price"${this._currentSortType === _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE ? ` checked` : ``}>
  ...
  _sortTypeChangeHandler(evt) {
    ...
    this._element.querySelector(`.trip-sort__item--day`).textContent = (evt.target.dataset.sortType !== _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT) ? `` : `Day`;
  }
...
class Statistics extends _smart_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(events) {
    ...
    this._moneyStatistics = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["countMoneyByTypes"])(this._event);
    this._transportStatistics = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["countTransportTrip"])(this._event);
    this._timeSpendStatistics = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["countTimeSpend"])(this._event);
...
class TripControls extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  _getTemplate() {
...
class TripInfo extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _createRouteTemplate() {
    ...
    const events = Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_1__["getEventsInOrder"])(this._events);
    ...
    : `<h1 class="trip-info__title">${destinationsUniq.join(` &mdash; `)}</h1>`}
      ...
      <p class="trip-info__dates">${Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_1__["getShortDate"])(startDay)}&nbsp;&mdash;&nbsp;${Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_1__["getShortDate"])(endDay)}</p>
      </div>`;
  }
